package myappconverter.simpleninjagame.scenes;
...
public class MainScene extends SKScene implements SKPhysicsContactDelegate{
	...
	public SKScene initWithSize(CGSize _size) {
		...
		this.setBackgroundColor(Color.WHITE); // this is white color
	...
	public void addMonster() {
		...
		SKAction loseAction = SKAction.runBlock(new runBlockBlock() {
			...
			public void perform() {
				...
				GameOverScene gameOverScene = (GameOverScene) GameOverScene.sceneWithSize(GameOverScene.class, MainScene.this.getSize());
